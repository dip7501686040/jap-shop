...
const CustomerDetailsSection: React.FC<CustomerDetailsSectionProps> = ({
  ...
  const DetailsContent = (
    <div className="absolute inset-0 flex flex-col h-full">
      ...
      {/* Bottom Buttons: YOU GAVE / YOU GOT - Fixed outside scrollable area */}
      <div className="flex gap-2 px-4 pb-4 pt-2 bg-black">
        <button
  ...
  // Desktop
  return (
    <div className="hidden md:block w-full md:w-1/2 p-0 bg-black h-full relative overflow-hidden">
      {DetailsContent}
