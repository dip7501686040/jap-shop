          ...
          <div>
            ...
            <p className="mt-2 text-center text-sm text-gray-600">
              ...
              <Link href="/auth/signup" className="font-medium text-blue-600 hover:text-blue-500">
                create a new account update 2025 new update
              </Link>
            </p>
          </div>
        ...
        <div className="flex items-center justify-center h-full px-4 py-12">
          <div className="max-w-md w-full space-y-8 text-white">
            <div className="text-center">
              ...
              <p className="text-xl mb-10">Manage your content and settings with our easy-to-use admin dashboard</p>
              <div className="flex justify-center">
                <Image src="/globe.svg" alt="Dashboard illustration" width={300} height={300} className="text-white" />
              </div>
            </div>
          </div>
        </div>
